# cmake-provided FindHDF5.cmake does not define targets, so fix it
# Copied from cmake-provided FindHdf5.cmake
# Deleted another call to find_package(HDF5) that causes strange behavior when building depending targets
...
if(HDF5_FOUND AND NOT TARGET HDF5::hdf5)
  ...
  set_target_properties(HDF5::hdf5 PROPERTIES
    ...
    IMPORTED_LOCATION /opt/tools/hdf5-gnu-1.8.8/lib/libhdf5.so
    INTERFACE_INCLUDE_DIRECTORIES /opt/tools/hdf5-gnu-1.8.8/include
  )
endif()
if(HDF5_FOUND AND NOT TARGET HDF5::hdf5_hl)
  ...
  set_target_properties(HDF5::hdf5_hl PROPERTIES
    IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
    IMPORTED_LOCATION /opt/tools/hdf5-gnu-1.8.8/lib/libhdf5_hl.so
    INTERFACE_INCLUDE_DIRECTORIES /opt/tools/hdf5-gnu-1.8.8/include
  )
endif()
